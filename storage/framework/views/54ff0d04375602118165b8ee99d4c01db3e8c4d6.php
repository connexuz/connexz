<?php $__env->startSection('title', app_name() . ' | ' . __('labels.frontend.page_title.interaction') ); ?>

<?php $__env->startPush('after-styles'); ?>
<?php echo e(style('css/owlcarousel/css/owl.carousel.min.css')); ?>

<?php echo e(style('css/owlcarousel/css/owl.theme.default.min.css')); ?>
...
<?php if(session()->get('flash_success') == 'Post added Successfully.'): ?>
<script>
...
<section class="wp-main-post-listing-wrap-area " id="friendpost_search">
    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-5 col-6">
                    <div class="conn-invite-btn-wrap" style="clear:both;">
                        ...
                        <input class="form-control mr-sm-12 col-md-12 friendposts_search_frontend deletable" type="search" name="friendposts_search_frontend" placeholder="Filter post's by friend. Enter a name" value="<?php echo e($request->get('friendposts_search_frontend')); ?>" aria-label="Search" autocomplete="off">
        ...
        <span style="display:none" class="div_loader" id="imgfrnposts"><img src="<?php echo e(asset('images/loader.gif')); ?>" /></span>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function frnpostsajax() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route("frontend.ajax_friendposts","ajax_friendposts")); ?>',
                    ...
                    success: function (data) {
                        $('#imgfrnposts').fadeOut();
                        var get_frenpost_page = parseInt($('#frenpost_page_number').val()) + parseInt("<?php echo e($pagelimit); ?>");
...
<section class="wp-main-post-listing-wrap-area" id="after_search_post">
    ...
    <div class="container">
        ...
        <span style="display:none" class="div_loader" id="imgmyposts"><img src="<?php echo e(asset('images/loader.gif')); ?>" /></span>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function mypostsajax() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route("frontend.ajax_myposts","ajax_myposts")); ?>',
                    ...
                    success: function (data) {
                        $('#imgmyposts').fadeOut();
                        var get_frenpost_page = parseInt($('#mypost_page_number').val()) + parseInt("<?php echo e($pagelimit); ?>");
...
<?php echo script('css/owlcarousel/js/owl.carousel.min.js'); ?>
...
<script>
    ...
    $(document).on("click", ".posts-view-popup", function () {
        ...
        $.ajax({
            ...
            type: "POST",
            url: '<?php echo e(route("frontend.post.view")); ?>',
            data: "id=" + id,
            success: function (data) {
...
<?php echo $__env->make('frontend.popup.invite', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
