...
<?php echo $__env->make('frontend.user.profile-photo', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php $__env->startPush('after-styles'); ?>
    <?php echo e(style('css/croppie.css')); ?>

<?php $__env->stopPush(); ?>

<?php echo e(html()->modelForm($logged_in_user, 'PATCH', route('frontend.user.profile.updateprofile'))->class('form-horizontal profile_form_submit')->attribute('enctype', 'multipart/form-data')->open()); ?>
                ...
                <div class="conn-main-tabs-section">
                    ...
                    <ul class="nav nav-tabs nav-tabs--vertical nav-tabs--left" role="navigation">
                        <div class="conn-profile-name-wrap">
                            <p class="text-left profile-name"><?php echo e($logged_in_user->name); ?></p>
                        </div>
                        <li class="nav-item">
                            ...
                            <div class="main-details-wrap">
                                ...
                                <div class="deatils-content-wrap">
                                    <p class="content-text">
                                        <?php echo e($logged_in_user->about); ?>
                                ...
                                <div class="main-detail-of-field-wrap">
                                    ...
                                    <div class="form-row first-group">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First name" value="<?php echo e($logged_in_user->first_name); ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="last_name" class="input-name">Last name*</label>
                                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last name" value="<?php echo e($logged_in_user->last_name); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group first-group">
                                        <label for="email" class="input-name">My Email*</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo e($logged_in_user->email); ?>">
                                    </div>
                                    <div class="form-group first-group date-of-birth-field">
                                        <label for="date_of_birth" class="input-name">Date of Birth*</label>
                                        <input type="text" class="form-control" id="date_of_birth" name="date_of_birth" placeholder="" value="<?php echo e(\Carbon\Carbon::parse($logged_in_user->date_of_birth)->format('m/d/Y')); ?>">
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-check-inline">
                                                    ...
                                                    <input class="form-check-input" type="radio" name="gender" id="gender_male" value="1" <?php echo e(($logged_in_user->gender == 1) ? "checked": ""); ?>>
                                                    <label class="form-check-label" for="gender_male">Male</label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <input class="form-check-input" type="radio" name="gender" id="gender_female" value="2" <?php echo e(($logged_in_user->gender == 2) ? "checked": ""); ?>>
                                    ...
                                    <div class="form-row first-group">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="city" name="city" value="<?php echo e($logged_in_user->city); ?>" placeholder="City">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="country" class="input-name">Country*</label>
                                            
                                            <?php echo Form::select('country',$countries, isset($logged_in_user->country) ? $logged_in_user->country : '', ['class' => 'form-control','id' => 'country','data-placeholder'=>'-- Select Country --','placeholder'=>'-- Select Country --','required'=>'required']); ?>
                                    ...
                                    <div class="form-group first-group">
                                        ...
                                        <textarea class="form-control" id="about" name="about" rows="3"><?php echo e($logged_in_user->about); ?></textarea>
                                    </div>
                            ...
                            <div class="main-details-wrap">
                                ...
                                <div class="main-detail-of-field-wrap">
                                    <div class="form-group first-group">
                                        ...
                                        <input type="text" class="form-control" id="university" name="university" value="<?php echo e($logged_in_user->university); ?>" placeholder="">
                                    </div>
                                    <div class="form-row first-group">
                                        <div class="form-group col-md-6">
                                            <label for="education_from_date" class="input-name">From</label>
                                            <input type="text" class="form-control" id="education_from_date" name="education_from_date" value="<?php echo e((!empty($logged_in_user->education_from_date))? \Carbon\Carbon::parse($logged_in_user->education_from_date)->format('m/d/Y') : ''); ?>" placeholder="From Date">
                                        </div>
                                        <div class="form-group col-md-6 first-group">
                                            <label for="education_to_date" class="input-name">To</label>
                                            <input type="text" class="form-control" id="education_to_date" name="education_to_date" value="<?php echo e((!empty($logged_in_user->education_to_date))? \Carbon\Carbon::parse($logged_in_user->education_to_date)->format('m/d/Y') : ''); ?>" placeholder="To Date">
                                        </div>
                                    </div>
                                    <div class="form-group first-group">
                                        <label for="education_about" class="input-name">My work experience</label>
                                        <textarea class="form-control" id="education_about" name="education_about" rows="3"><?php echo e($logged_in_user->education_about); ?></textarea>
                                    </div>
                                    <div class="form-group form-check">
                                        <input id="graduted" type="checkbox" name="graduted" value="1" <?php echo e(($logged_in_user->graduted == 1) ? "checked": ""); ?>>
