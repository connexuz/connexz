        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="post-social-form-wrap">
                    <?php echo e(html()->form('POST', route('frontend.post.create'))->class('post-social-form')->id('addPost-form')->attribute('enctype', 'multipart/form-data')->open()); ?>

                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo e(html()->textarea('post_description')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <?php echo e(form_submit('Publish')->class('btn send-invitation-btn')); ?>
