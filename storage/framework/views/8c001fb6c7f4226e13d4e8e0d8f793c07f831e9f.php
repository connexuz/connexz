 ...
 <?php $__env->startSection('title', app_name() . ' | ' . __('labels.frontend.page_title.settings')); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="conn-profile-cover-img-section-wrap">
                    <img src="<?php echo e($logged_in_user->cover_image); ?>" class="img-fluid conn-profile-cover-img">
                    <div class="conn-profile-img-wrap-section">
                        <img src="<?php echo e($logged_in_user->avatar_location); ?>" class="img-fluid conn-profile-cover-img-subimg rounded-circle">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="main-detail-of-field-wrap">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-4">
                                                <div class="block for-slide-btn">
                                                    <input data-index="1" id="show_comment" type="checkbox" <?php echo e((auth()->user()->show_comment) ? 'checked' : ''); ?> onchange="change_status('show_comment','<?php echo e(route('frontend.user.change.status')); ?>','<?php echo e(csrf_token()); ?>')">
                                    ...
                                    <div class="slide-btn-wrap">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-4">
                                                <div class="block for-slide-btn">
                                                    <input data-index="1" id="add_comment" type="checkbox" <?php echo e((auth()->user()->add_comment) ? 'checked' : ''); ?> onchange="change_status('add_comment','<?php echo e(route('frontend.user.change.status')); ?>','<?php echo e(csrf_token()); ?>')">
                                    ...
                                    <div class="slide-btn-wrap">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-4">
                                                <div class="block for-slide-btn">
                                                    <input data-index="1" id="add_likes" type="checkbox" <?php echo e((auth()->user()->add_likes) ? 'checked' : ''); ?> onchange="change_status('add_likes','<?php echo e(route('frontend.user.change.status')); ?>','<?php echo e(csrf_token()); ?>')">
                                    ...
                                    <div class="slide-btn-wrap">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-4">
                                                <div class="block for-slide-btn">
                                                    <input data-index="1" id="show_profile" type="checkbox" <?php echo e((auth()->user()->show_profile) ? 'checked' : ''); ?> onchange="change_status('show_profile','<?php echo e(route('frontend.user.change.status')); ?>','<?php echo e(csrf_token()); ?>')">
                                    ...
                                    <div class="slide-btn-wrap">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-4">
                                                <div class="block for-slide-btn">
                                                    <input data-index="1" id="show_email" type="checkbox" <?php echo e((auth()->user()->show_email) ? 'checked' : ''); ?> onchange="change_status('show_email','<?php echo e(route('frontend.user.change.status')); ?>','<?php echo e(csrf_token()); ?>')">
                            ...
                            <div class="main-details-wrap">
                                ...
                                <div class="main-detail-of-field-wrap connexuz-payment-wrap">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="deatils-content-wrap">
                                                <?php echo e(html()->form('POST', route('frontend.user.charge.card'))->id('paymentForm')->open()); ?>
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        data-apiLoginID="<?php echo e($settings['payment_login_id']); ?>"
                                                        data-clientKey="<?php echo e($settings['payment_client_key']); ?>"
