<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        Connxuz
        <!-- <img class="navbar-brand-full" src="<?php echo e(asset('img/backend/brand/logo.svg')); ?>" width="89" height="25" alt="SocialEngine Logo"> -->
        <img class="navbar-brand-minimized" src="<?php echo e(asset('img/backend/brand/sygnet.svg')); ?>" width="30" height="30" alt="SocialEngine Logo">
    </a>
    ...
    <ul class="nav navbar-nav ml-auto user-account-dropdown" style="padding-right: 10px;">
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <img src="<?php echo e($logged_in_user->avatar_location); ?>" class="img-avatar" alt="<?php echo e($logged_in_user->email); ?>">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="<?php echo e(route('admin.auth.user.show',$logged_in_user->id)); ?>">
