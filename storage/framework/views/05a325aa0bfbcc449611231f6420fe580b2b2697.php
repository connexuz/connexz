                ...
                <div class="col-md-4">
                    <div class="conn-profile-img-wrap">
                        <div class="connexuz-cover-img-wrap">
                            <img src="<?php echo e($logged_in_user->cover_image); ?>" class="img-fluid connexuz-cover-img">
                            <!-- <p class="conn-user-name"><?php echo e($logged_in_user->name); ?></p> -->
                        </div>
                        <img src="<?php echo e($logged_in_user->avatar_location); ?>" class="img-fluid conn-user-img rounded-circle" width="70px" height="70px;">
